...
<html lang="en">
    ...
    <div class="main-container d-flex">
        ...
        <h1 class="fs-4"> Chat   <span class="bg-white text-dark rounded shadow px-2 me-2"> Arroz </span>
        ...
        <div>
            ...
            <ul class="list-unstyled px-2">
               <li class=""><a href="#" class="text-decoration-none d-flex justify-content-between px-3 py-2 d-block">
            ...
            <ul class="list-unstyled px-2">
               <li class=""><a href="#" class="text-decoration-none px-3 py-2 d-block"><i class="fa-solid fa-user-group"></i>Amigos</a></li>
            </ul>
